...
public class MainActivity extends AppCompatActivity {
    ...
    private void getResults() {
        ...
        labeler.processImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionImageLabel>>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(MainActivity.this, "OOPS! We failed to detect image...", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void getSearchResults(String searchQuery) {
        String url = "https://serpapi.com/search.json?q="+searchQuery+"&location=Karnataka,India&hl=en&gl=us&google_domain=google.com&api_key=da1995f77093ba5b1dcbe457d8604a8deec76aefb1869a8cf1cbd03eed283476";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MainActivity.this, "OOPS! we failed to get search results...", Toast.LENGTH_SHORT).show();
            }
        });
